...
import com.willblaschko.android.alexa.speechutils.utils.AudioUtils;
...
public abstract class AbstractAudioRecorder implements AudioRecorder {
    ...
    AbstractAudioRecorder(int audioSource, int sampleRate) {
    ...
    void createRecorder(int audioSource, int sampleRate, int bufferSize) {
    ...
    // TODO: remove
    void createBuffer(int framePeriod) {
     ...
     */
    private int read(SpeechRecord recorder, byte[] buffer) {
     ...
     */
    private byte[] getCompleteRecording() {
    ...
    private static byte[] getRecordingAsWav(byte[] pcm, int sampleRate) {
    ...
    private void setConsumedLength(int len) {
        mConsumedLength = len;
    }

    private void setRecordedLength(int len) {
        mRecordedLength = len;
    }
    ...
    private void recorderLoop(SpeechRecord recorder) {
